...
public class PeppaTracePrometheusLoadBalancerFeignClient
        extends TraceLoadBalancerFeignClient {
    private static final Log log = LogFactory.getLog(PeppaTracePrometheusLoadBalancerFeignClient.class);
    private final BeanFactory beanFactory;

    public PeppaTracePrometheusLoadBalancerFeignClient(Client delegate, CachingSpringLoadBalancerFactory lbClientFactory, SpringClientFactory clientFactory, BeanFactory beanFactory) {
