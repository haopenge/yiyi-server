...
public class PeppaPrometheusFeignClient
        implements Client {
    private static final Log log = LogFactory.getLog(PeppaPrometheusFeignClient.class);
    private final Client delegate;

    public PeppaPrometheusFeignClient(Client delegate) {
