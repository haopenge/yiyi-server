...
public class PrometheusFeignCounter {
    ...
    @Value("${yiyi.feigncheckpoint.log404:true}")
    ...
    @ApolloConfigChangeListener(interestedKeys = {"yiyi.feigncheckpoint.log404"})
    private void configChangeListter(ConfigChangeEvent changeEvent) {
        if (changeEvent.isChanged("yiyi.feigncheckpoint.log404")) {
            this.log404 = changeEvent.getChange("yiyi.feigncheckpoint.log404").getNewValue();
            Log404 = this.log404;
