...
public class PeppaMqProducter implements Closeable {
    private static final Logger log = LoggerFactory.getLogger(PeppaMqProducter.class);
    ...
    private Map<String, PeppaMqProduceMessageConfirm> peppaMqProduceMessageConfirmMap;
    ...
    private TransactionMQProducer createTransactionMQProducer(TransactionMQProducer transactionMQProducer) {
        ...
        transactionMQProducer.setTransactionListener(new TransactionListener() {
            ...
            public LocalTransactionState executeLocalTransaction(Message message, Object o) {
                ...
                PeppaMqProduceMessageConfirm peppaMqProduceMessageConfirm = (PeppaMqProduceMessageConfirm) PeppaMqProducter.this.peppaMqProduceMessageConfirmMap.get(topic);
                if (peppaMqProduceMessageConfirm != null) {
                    try {
                        peppaMqProduceMessageConfirm.confirm(message);
                        this.localTrans.put(transactionId, Integer.valueOf(1));
                        return LocalTransactionState.COMMIT_MESSAGE;
                    } catch (Exception e) {
                        PeppaMqProducter.log.error("topic:{},事务消息本地调用失败,e:{}", topic, e);
                        this.localTrans.put(transactionId, Integer.valueOf(2));
                        return LocalTransactionState.ROLLBACK_MESSAGE;
                    }
                }
                PeppaMqProducter.log.info("topic:{},{}", topic, "没可用本地确认");
            ...
            public LocalTransactionState checkLocalTransaction(MessageExt messageExt) {
                ...
                PeppaMqProducter.log.info("check local transaction, topic:{},transactionId:{}", messageExt.getTopic(), transactionId);
                ...
                if (null != status) {
                    ...
                    switch (status.intValue()) {
                        case 0:
                            ...
                            PeppaMqProducter.log.info("localTrans size:{}", Integer.valueOf(size));
    ...
    public void setPeppaMqProduceMessageConfirmMap(Map<String, PeppaMqProduceMessageConfirm> peppaMqProduceMessageConfirmMap) {
        this.peppaMqProduceMessageConfirmMap = peppaMqProduceMessageConfirmMap;
    }
