...
import com.peppa.service.gateway.b.auth.TokenDecoder;
...
public class RequestTokenUserFilter
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        exchange.getAttributes().put("peppa-token-user", tokenUser);
    ...
    private String getTokenFromRequest(ServerHttpRequest request) {
        ...
        if (StringUtils.isBlank(ssoAccessToken)) {
            ...
            if (!cookies.containsKey("peppa_sso_token")) {
                return ssoAccessToken;
            }
            ssoAccessToken = ((HttpCookie) cookies.getFirst("peppa_sso_token")).getValue();
        }
        return ssoAccessToken;
    }
