package com.peppa.service.gateway.service;

import com.peppa.common.response.Response;
import com.peppa.service.gateway.b.auth.TokenUser;
import com.peppa.service.gateway.b.auth.UimFeign;
import com.peppa.service.gateway.c.auth.UserAuthFeign;
import com.peppa.service.gateway.filter.AuthFilterConfig;
...
public class AuthService {
    ...
    public boolean localVerifyToken(ServerWebExchange exchange, AuthFilterConfig config, String clientIdInRequest) {
        ...
        TokenUser tokenUser = (TokenUser) exchange.getAttributes().getOrDefault("peppa-token-user", null);
