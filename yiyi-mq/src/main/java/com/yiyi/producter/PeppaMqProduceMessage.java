...
@Slf4j
public class yiyiMqProduceMessage {
    ...
    public yiyiMqProduceMessage() {
        log.info("yiyi mq yiyiMqProduceMessage init!");
    ...
    private void dealMessageGray(Message message) {
        ...
        try {
            ...
            log.warn("MQ生成者{}没有找到，没有引用架构组件！微服务环境必须引用！", "com.yiyi.common.grayconfig.ThreadAttributes");
        }
