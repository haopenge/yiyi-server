...
import com.yiyi.service.gateway.gray.factory.StrategyFactory;
...
public class yiyiGrayBalanceRule extends RoundRobinRule {
    private static final Logger log = LoggerFactory.getLogger(yiyiGrayBalanceRule.class);
